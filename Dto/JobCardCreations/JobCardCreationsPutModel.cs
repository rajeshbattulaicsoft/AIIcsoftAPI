...
{
    public class JobCardCreationsPutModel
    {
        ...
        public List<JobCardUpdateGridData>? griddata { get; set; }
    }
    public class JobCardUpdateGridData
    {
        public int gridautoid { get; set; }
        public int rawmatid { get; set; }
